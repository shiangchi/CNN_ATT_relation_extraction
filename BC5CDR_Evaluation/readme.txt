...
****for our system, the commandline is 'sh eval_relation.sh PubTator data/gold/CDR_TestSet.PubTator.txt data/test/add_pos_result_remove_hypernym.Pubtator_to2.txt filter_ans_to2.txt'

for example : sh eval_relation.sh PubTator data/gold/CDR_TestSet.PubTator.txt /home/hsu/Documents/simple_cnn_cdr/convert2pub/cnn_across_only_across  eval/cnn_across_only
